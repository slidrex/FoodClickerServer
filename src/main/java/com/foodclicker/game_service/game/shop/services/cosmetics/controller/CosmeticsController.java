...
public class CosmeticsController {
    ...
    private ResponseEntity<?> buyCosmetics(@RequestBody BuyCosmeticsRequest request) throws ItemAlreadyOwnedException, NotEnoughMoneyException, UnknownUserException, UnknownCosmeticsTemplateException {
